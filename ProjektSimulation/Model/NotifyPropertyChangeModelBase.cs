...
namespace ProjektSimulation.Model
{
    ...
    /// Klasse aus MvvmFoundation von Josh Smith  
    /// </summary>
    public abstract class NotifyPropertyChangeModelBase : INotifyPropertyChanged
    {
        #region Constructor

        protected NotifyPropertyChangeModelBase()
        {
        }
